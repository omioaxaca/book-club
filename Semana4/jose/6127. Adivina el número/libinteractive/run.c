...
static const char* pipeNames[] = {
	"./AdivinaElNumero_in", "./AdivinaElNumero_out"
};
static char* const commands[][2] = {
	{ "libinteractive/Main/Main", NULL },
	{ "libinteractive/AdivinaElNumero/AdivinaElNumero", NULL },
};
static char* const debug_commands[][5] = {
	{ "libinteractive/Main/Main", NULL, NULL, NULL, NULL },
	{ "/usr/bin/gdbserver", "127.0.0.1:8042", "libinteractive/AdivinaElNumero/AdivinaElNumero_debug", "--print-ready", NULL },
};
